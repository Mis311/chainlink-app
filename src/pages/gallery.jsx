...
export default function Gallery() {
  ...
  console.log(
    '____gallery.jsx:9 ~ Gallery ~ account, contract:',
    account,
    contract?._methods,
  )
...
— 罗杰·费舍尔（Roger Fisher），《原子科学家通讯》（Bulletin of the Atomic Scientists），1981年3月`,
  ...
  const donate = async () => {
    ...
    if (contract) {
      ...
      alert(`You donation of 0.001 Matic  was sent successfully`)
    }
  }
  ...
  return (
    <>
      ...
      <div className="bg-gray-50 min-h-screen">
        ...
        <button className="btn btn-outline btn-accent mx-2" onClick={donate}>
          Donate Now
        </button>
